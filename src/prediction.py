...
class prediction_config:
  def __init__(self,params):
    ...
    self.model2=params["model2"]
    self.model3=params["model3"]
    self.model4=params["model4"]
...
class predict:
  def __init__(self,prediction_config):
    ...
    self.model2=prediction_config.model2
    self.model3=prediction_config.model3
    self.model4=prediction_config.model4

  def predict_image(self, image, selected_model):
